...
export default function Hero() {
  ...
  return (
    <section id="home" style={{minHeight:"100vh",display:"flex",alignItems:"center",padding:"80px 24px",background:"#070a0f",position:"relative",overflow:"hidden"}}>
      ...
      <div style={{maxWidth:"1200px",width:"100%",margin:"0 auto",display:"grid",gridTemplateColumns:"1fr 1fr",gap:"64px",alignItems:"center"}}>
        <div>
          ...
          <h1 style={{fontSize:"clamp(36px,5vw,58px)",fontWeight:700,color:"#fff",lineHeight:1.15,marginBottom:"8px"}}>Franklin Chinonso Osuji</h1>
          <div style={{fontSize:"clamp(18px,2.5vw,24px)",fontWeight:600,color:"#60a5fa",marginBottom:"12px"}}>Cloud & DevOps Engineer</div>
          <div style={{display:"inline-flex",alignItems:"center",gap:"8px",padding:"4px 12px",borderRadius:"6px",border:"1px solid rgba(249,115,22,0.4)",background:"rgba(249,115,22,0.08)",marginBottom:"24px"}}>
          ...
          <p style={{color:"#8b949e",fontSize:"16px",lineHeight:1.8,marginBottom:"32px"}}>Specialising in Terraform, CI/CD automation, and containerised cloud infrastructure using Docker and Amazon ECS. Building scalable AWS environments that deliver high-availability and cost-efficient solutions.</p>
          <div style={{display:"flex",gap:"12px",flexWrap:"wrap",marginBottom:"32px"}}>
            ...
            <a href="/cv.html" target="_blank" style={{padding:"10px 20px",border:"1px solid rgba(59,130,246,0.4)",color:"#60a5fa",borderRadius:"8px",textDecoration:"none",fontSize:"14px",fontWeight:600}}>CV</a>
          </div>
