    ...
    <section id="about" className="section-pad" style={{background:"#070a0f"}}>
      <div style={{maxWidth:"1200px",margin:"0 auto"}}>
        <div style={{marginBottom:"48px"}}>
          ...
          <h2 style={{fontSize:"clamp(24px,4vw,40px)",fontWeight:700,color:"#fff",marginBottom:"16px"}}>Professional Summary</h2>
          <div style={{width:"48px",height:"2px",background:"#3b82f6"}} />
        </div>
        <div className="grid-2col">
          <div>
            <p style={{color:"#8b949e",fontSize:"clamp(14px,2vw,17px)",lineHeight:1.8,marginBottom:"20px"}}><strong style={{color:"#fff"}}>AWS-Certified Cloud & DevOps Engineer</strong> specializing in <strong style={{color:"#fff"}}>Infrastructure as Code (Terraform)</strong> and <strong style={{color:"#fff"}}>Containerization (Docker/ECS)</strong>. Bridging the gap between legacy IT and automated cloud environments, combining over <strong style={{color:"#fff"}}>4 years of professional experience</strong> with 1,800 units of intensive DevOps training at DCI.</p>
